...
def write_run_metadata(
    ...
    tracked_env_keys = [
        ...
        "DATASELECTOR_TILE_EXCLUSION_POLICY",
        "DATASELECTOR_APPLY_TILE_EXCLUSION",
        "DATASELECTOR_STRICT_CRS",
        "DATASELECTOR_STRICT_EXPLICIT_CRS",
        "DATASELECTOR_ALLOW_HEURISTIC_CRS_FALLBACK",
        "DATASELECTOR_METRIC_EPSG",
