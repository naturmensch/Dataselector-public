...
def make_fake_run(seed: int, kind: str = 'hamburg', is_xxl_final: bool = False, n_trials: int = 10):
...
def _sim_run_cmd_with_retry(cmd: str, retries: int = 2, delay: int = 5, cwd=None, fail_ok: bool = False) -> int:
...
def main() -> int:
    ...
    ok = phase_2_reproducibility(seeds=[43, 44], n_trials=10, n_candidates=5, pass_params=True)
