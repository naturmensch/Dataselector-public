...
def test_lazy_greedy_basic():
    ...
    sel = DiversitySelector(n_samples=n_select, use_multi_criteria=False, use_lazy_greedy=True)
...
def test_lazy_greedy_matches_standard():
    ...
    sel_lazy = DiversitySelector(n_samples=n_select, use_multi_criteria=False, use_lazy_greedy=True)
    res_lazy = sel_lazy.select(features, metadata, spatial_constraint=False)

    sel_std = DiversitySelector(n_samples=n_select, use_multi_criteria=False, use_lazy_greedy=False)
