...
def test_db_inspection_counts(tmp_path):
    ...
    cur.execute('INSERT INTO trials (trial_id, number, state) VALUES (1, 0, "TrialState.COMPLETE")')
    cur.execute('INSERT INTO trials (trial_id, number, state) VALUES (2, 1, "TrialState.COMPLETE")')
    cur.execute('INSERT INTO trials (trial_id, number, state) VALUES (3, 2, "TrialState.RUNNING")')
