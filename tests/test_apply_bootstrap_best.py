...
from apply_bootstrap_best import find_best_bootstrap_candidate, inject_into_config, write_new_config
...
def test_inject_into_config():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert updated_cfg['selection']['_bootstrap_provenance']['composite_score'] == pytest.approx(0.85)
