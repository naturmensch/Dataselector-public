...
@pytest.mark.sampler
def test_sampler_suite_smoke(tmp_workspace: Path, sample_csv: Path, run_dataselector_cli):
...
@pytest.mark.integration
@pytest.mark.sampler
def test_sampler_suite_produces_selection(tmp_workspace: Path, sample_csv: Path, run_dataselector_cli):
