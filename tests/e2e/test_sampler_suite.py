...
def test_thesis_sampler_suite_help_and_legacy_flag_rejection(run_dataselector_cli):
    ...
    help_result = run_dataselector_cli(
        ["thesis-sampler-suite", "--help"], capture_output=True
    )
    ...
    legacy = run_dataselector_cli(
        ["sampler-suite", "--csv", "data/new_all_tiles.csv"], capture_output=True
    )
